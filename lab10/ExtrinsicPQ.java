...
public interface ExtrinsicPQ<T> {
    /* Inserts an item with the given priority value. Also known as "enqueue", or "offer". */
    public void insert(T item, double priority);
    /* Returns the minimum item. Also known as "min". */
    public T peek();
    /* Removes and returns the minimum item. Also known as "dequeue". */
    public T removeMin();
    /* Changes priority of the given item. The behavior if the item doesn't exist is undefined. */
